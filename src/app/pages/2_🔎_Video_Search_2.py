    ...
    if prompt := st.chat_input("Search text"):
        ...
        if len(response) == 0:
            ...
            with messages.chat_message("assistant"):
                ...
                assets_container_name = os.environ["AZURE_COSMOS_DB_VIDEO_ASSETS_CONTAINER_NAME"]
                asset_info = st.session_state.search_agent.perform_search(assets_container_name, filter={"asset_name": asset_name}, limit=1)
                print(asset_info)
                # Get the video url
